/*
    ...
    Copyright (c) 2013 Gianfranco Costamagna <costamagnagianfranco@yahoo.it> (some really minor changes to make it compliant with 802.15.4 interfaces)
*/
...
int main(int argc, char *argv[]) {
	...
	ltype = 804; /// MAGICCCCCCC :) from linux 802_15_4
        stype=ltype;
	if (stype != 0) {
